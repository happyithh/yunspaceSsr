        ...
        <div class="w1200">
            ...
            <div class="section site-item itembox">
                ...
                <ul class="fl site-menu clearfix">
                    <li class="current"><a href="/site/hot">热推场地</a></li>
                    <li><a href="/site/selected">精选分类</a></li>
                ...
                <div class="tab-box site-cont site-cont-list clearfix">
                    ...
                    <div class="cont matrix-cont current clearfix">
                        <div class="box-list clearfix">
                            <div class="box" v-for="item in hotSites">
                                <a href="javascript:;">
                                    <img src="" :alt="item.title">
                                    <p class="text" v-html="item.title">场地名字</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cont list-cont clearfix">
                        <div class="box-list clearfix">
                            <div class="box-list-box" v-for="item in hotSites">
...
<script>
    ...
    export default {
        ...
        computed: {
            hotSites(){
                return this.$store.state.SiteList.hot
            }
        },
        methods: {
